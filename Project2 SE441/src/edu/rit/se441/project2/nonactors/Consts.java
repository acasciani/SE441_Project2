...
public enum Consts {
	...
	DEBUG_MSG_CHLD_ALR_INIT					("My children [%s] was already initialized"),
	DEBUG_MSG_REG_MY_CHILD					("Registering my children [%s]"),
	DEBUG_MSG_INIT_MY_CHILD					("Initializing my children [%s]"),
	DEBUG_MSG_TELL_PRT_TO_REG				("Telling my parent to register [%s]"),
	DEBUG_MSG_TELL_PRT_TO_INIT				("Telling my parent to initialize [%s]"),
